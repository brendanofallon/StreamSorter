...
public class QueuingDeflaterStream extends OutputStream {
	 ...
	 private static int defaultCompressionLevel = BlockCompressedStreamConstants.DEFAULT_COMPRESSION_LEVEL;
	     ...
	     */
	    public QueuingDeflaterStream(final String filename) {
	     ...
	     * Uses default compression level, which is 5 unless changed by setDefaultCompressionLevel
	     */
	    public QueuingDeflaterStream(final File file) {
	     ...
	     * @param compressionLevel 1 <= compressionLevel <= 9
	     */
	    public QueuingDeflaterStream(final String filename, final int compressionLevel) {
	     ...
	     * @param compressionLevel 1 <= compressionLevel <= 9
	     */
	    public QueuingDeflaterStream(final File file, final int compressionLevel) {
	        this.file = file;
	     ...
	     * file may be null
	     */
	    public QueuingDeflaterStream(final OutputStream os, File file) {
	        this(os, file, defaultCompressionLevel);
	    }

	    public QueuingDeflaterStream(final OutputStream os, final File file, final int compressionLevel) {
	        this.file = file;
	    ...
	    public long getFilePointer(){
	        return makeFilePointer(mBlockAddress, numUncompressedBytes);
	    }
	    ...
	    /********** Copied from net.sf.samtools.util.BlockCompressedFilePointerUtil, where this static
	     * block isn't accessible.             **************/    
